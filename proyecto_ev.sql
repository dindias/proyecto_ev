...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2023 a las 18:34:26
...
(50, 1, 'Toyota', 'Corolla', '2018', 'EFG5678', 80000, 'Como nuevo, poco kilometraje', 15000, 'img/generic.jpg'),
(51, 1, 'Toyota', 'Camry', '2017', 'FGH6789', 110000, 'Perfectas condiciones', 13000, 'img/generic.jpg'),
(52, 1, 'Nissan', 'Sentra', '2014', 'GHI7890', 100000, 'Pequeños rasguños en pintura', 7500, 'img/generic.jpg'),
(53, 1, 'Hyundai', 'Elantra', '2019', 'HIJ8901', 50000, NULL, 16000, 'img/generic.jpg'),
(54, 1, 'Volkswagen', 'Golf', '2013', 'IJK9012', 140000, NULL, 7000, 'img/generic.jpg'),
(55, 1, 'BMW', 'Series 3', '2020', 'JKL0123', 30000, 'Excelente estado, un solo dueño', 22000, 'img/generic.jpg'),
(56, 1, 'Audi', 'A4', '2016', 'KLM1234', 90000, 'Pocos detalles de uso', 18000, 'img/generic.jpg'),
(57, 1, 'Mercedes-Benz', 'C-Class', '2021', 'LMN2345', 10000, 'Como nuevo', 25000, 'img/generic.jpg'),
(58, 1, 'Ford', 'Mustang', '2019', 'MNO3456', 40000, 'Perfectas condiciones, poco kilometraje', 26000, 'img/generic.jpg'),
(59, 1, 'Chevrolet', 'Spark', '2017', 'NOP4567', 95000, NULL, 8000, 'img/generic.jpg'),
(60, 1, 'Renault', 'Duster', '2018', 'OPQ5678', 65000, 'Buen estado, bien cuidado', 9000, 'img/generic.jpg'),
(61, 1, 'Toyota', 'Yaris', '2023', 'JDH7777', 1, 'Nuevo', 30000, 'img/generic.jpg'),
...
(70, 1, 'BMW', 'M3', '2023', 'LLL9999', 2, 'Nuevo', 70000, 'img/1366_2000.jpeg'),
(71, 1, 'Volkswagen', 'Polo', '2009', 'MMM2222', 2, 'Viejo', 5000, 'img/generic.jpg');
...
--
ALTER TABLE `coches`
  MODIFY `CarID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
